...
<form action="" method="POST">
    ...
    <table class="table">
        ...
        <tr>
            <td>First Name</td>
            <td><input type="text" name="fname" class="form-control" value="<?php echo $sonuc['fname']; ?>">
            </td>
        </tr>

        <tr>
            <td>Last Name</td>
            <td><textarea name="lname" class="form-control"><?php echo $sonuc['lname']; ?></textarea></td>
        </tr>
        ...
        <tr>
            <td>Company</td>
            <td><textarea name="company" class="form-control"><?php echo $sonuc['company']; ?></textarea></td>
        </tr>
...
if ($_POST) { 
    ...
    if ($baglanti->query("UPDATE employee SET fname = '$fname', lname = '$lname', email = '$email', phone = '$phone', company = '$company' WHERE id =".$_GET['id'])) {
